...
class FormularioEquipoPrincipal(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'tipo': forms.TextInput(attrs={'id':'tipo','class':'form-control','placeholder':'Tipo'}),
            'codigo_de_activo': forms.TextInput(attrs={'id':'codigo_activo','class':'form-control','placeholder':'Código de activo'}),
            'año':forms.DateInput(attrs={'type':'text','class':'form-control','placeholder':'Fecha de instalación (dd/mm/aa)'}),
            ...
            'temperatura': forms.TextInput(attrs={'id':'temp','class':'form-control','placeholder':'Temperatura'}),           
            ...
            'fu_mantenimiento':forms.DateInput(attrs={'type':'text','class':'form-control','placeholder':'Fecha de último mantenimiento integral (dd/mm/aa)'}),
